...
%
Calculus of Covalent Bonding, or CCB for short, was fully defined in~\cite{KU2017}. We recall some of the main definitions in order to make the paper more self-contained. We note, however, that some SOS rules 
