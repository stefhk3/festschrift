...
$\epsilon$ is the empty collection of sites. We shall denote collections where all sites are fully bonded as $\eta$.
...
$$ 
We notice that, following the first transition, the $h[2]$ bond can be broken, and correspondingly the $c[1]$ bond can be broken after the second transition. Since creation and breaking of such bonds is almost instantaneous, we have added 
