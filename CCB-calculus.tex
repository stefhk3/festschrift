...
\Rule
{\fresh{k}{s,s'}}
{(s,a[k],s';b) \xrightarrow{\underline{a}[k]}_s (s,a,s';b)}
\qquad &
\rulename{rev c}\
\Rule
...
Figures \ref{fig:yc1sos}--\ref{fig:xc2sos} contain the SOS rules that define the new concerted actions transitions. 
...
with a pair of concerted actions by rule \rulename{concert1} in Figure~\ref{fig:c1sos}
...
We clearly have the following pair of concerted actions derived by 
