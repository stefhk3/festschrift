...
which can form bonds with sites of other molecules, we shall write the sites as composed in parallel:  $(s;b) \Mid  \ldots \Mid (s';b')$. Such expressions will be used to define the prefix operator. More formally, a site $\sigma$ is either $(s;b)$ or $(s)$. A collection $\mu$ is either $\sigma$ or $\sigma\Mid\sigma$.
...
\Rule
{U\equiv P \paral Q \quad  P\xrightarrow{(b)[k]}P'\xrightarrow{\underline{a}[l]}P'' 
  \quad Q\xrightarrow{\alpha[k]}Q' \xrightarrow{\underline{e}[m]}Q''
  \quad R\xrightarrow{\underline{d}[l],\underline{f}[m]}R'' % %\quad \fresh{k}{Q} 
 }
{U \paral R\xrightarrow{\{e[k],\underline{f}[l]\}} P'' \paral Q''\paral R''} (*)\\[25pt]
\rulename{concert}\ 
\Rule
