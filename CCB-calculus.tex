...
$\epsilon$ is the empty collection of sites.
...
$\gamma(g,h)=j$.
%
\emph{The new concert2 and concert3 rules should be OK. I keep old concert rule for comparison for the time being. The last three rules need adjusting}.}
