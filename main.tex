...
\end{array}$$
%
where processes $A$, $T$, $G$, and $C$ model the bases adenine (A), cytosine (C), guanine (G), and thymine (T). Notice we have added actions s, m, and r. Also the actions on DP have been regrouped (but all original actions are still there).
...
\end{array}$$
%
where processes $MS$, $ML$, $MH$, and $UD$ model the MutS, MutL, MutH, and UvrD protein respectively.  Here $s$, $i$, and $r$ are weak actions, all other actions, namely $p3$, $p5$, $b$, $b$, $d$, $b$, $a$, $t$, $g$, $c$, m, n, m2, l, o, s, u, v and w are strong. Notice that $i$ is not used, but we keep it to have this model as an extension of the BER model.
...
\psfrag{2}{${\mathrm{2}}$}
  ...
  \caption[A five base pair DNA fragment.]{A four base pair DNA fragment, with a DNA mismatch and methylation of one strand.}
  \label{fig:state1}
\end{figure}
...
%
\begin{flalign*}
&(p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[26]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
...
&(b_9[10];i_9).(c_1[23]).C_1' \paral (b_{10}[11];i_{10}).(c_2[27]).C_2' \paral (b_{11}[20];i_{11}).(c_3[25]).C_3'  \paral&&\\
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[13],p5_9[14];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10}[14],p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n).Me'\paral (m2,m2).(l).MS' \paral (l).(n).(o).ML' \paral &&\\
&(o).(w).MH' \paral (u;r).(v;s).UD'&&
\end{flalign*}

MutS can now bond to the A and G bases via the t and g actions. This is the recognition of the mismatch. The bonding is not possible if the bases are properly paired, and also not if a Uracil is incorporated into the strand (as in the BER example). The transition for the bonding of MutS is as follows:

\begin{flalign*}
&\xrightarrow{\{m2a[28]\}} \xrightarrow{\{m2g[29]\}} (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[24];r_2).T_2' \paral  (b_6[9];i_6).(g_1[25];r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
&(b_9[10];i_9).(c_1[23]).C_1' \paral (b_{10}[11];i_{10}).(c_2[27]).C_2' \paral (b_{11}[20];i_{11}).(c_3[25]).C_3'  \paral&&\\
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[13],p5_9[14];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10}[14],p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n).Me'\paral (m2[28],m2[29]).(l).MS' \paral (l).(n).(o).ML' \paral &&\\
&(o).(w).MH' \paral (u;r).(v;s).UD'&&
\end{flalign*}

Now it is possible for MutL to bond to MS:

\begin{flalign*}
&\xrightarrow{\{ll[30]\}} (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[24];r_2).T_2' \paral  (b_6[9];i_6).(g_1[25];r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
...
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[13],p5_9[14];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10}[14],p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n).Me'\paral (m2[28],m2[29]).(l[30]).MS' \paral (l[30]).(n).(o).ML' \paral &&\\
&(o).(w).MH' \paral (u;r).(v;s).UD'&&
\end{flalign*}
...
\begin{flalign*}
&\xrightarrow{\{nn[31]\}} (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[24];r_2).T_2' \paral  (b_6[9];i_6).(g_1[25];r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
...
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[13],p5_9[14];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10}[14],p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n[31]).Me'\paral (m2[28],m2[29]).(l[30]).MS' \paral (l[30]).(n[31]).(o).ML' \paral &&\\
&(o).(w).MH' \paral (u;r).(v;s).UD'&&
\end{flalign*}
...
\begin{flalign*}
&\xrightarrow{\{oo[32]\}} (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[24];r_2).T_2' \paral  (b_6[9];i_6).(g_1[25];r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
...
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[13],p5_9[14];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10}[14],p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n[31]).Me'\paral (m2[28],m2[29]).(l[30]).MS' \paral (l[30]).(n[31]).(o[32]).ML' \paral &&\\
&(o[32]).(w).MH' \paral (u;r).(v;s).UD'&&
\end{flalign*}

MutH is now ready to cleave the DNA at the right location:

\begin{flalign*}
&\xrightarrow{\{ws[33],\underline{p5p3}[14]\}} \Rightarrow (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[24];r_2).T_2' \paral  (b_6[9];i_6).(g_1[25];r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
&(b_9[10];i_9).(c_1[23]).C_1' \paral (b_{10}[11];i_{10}).(c_2[27]).C_2' \paral (b_{11}[20];i_{11}).(c_3[25]).C_3'  \paral&&\\
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[13],p5_9[33];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10},p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n[31]).Me'\paral (m2[28],m2[29]).(l[30]).MS' \paral (l[30]).(n[31]).(o[32]).ML' \paral &&\\
&(o[32]).(w[33]).MH' \paral (u;r).(v;s).UD'&&
\end{flalign*}

Note that execution of c on $DP_9$ leads to breaking a bond between two deoxyribose/phosphate groups. We use a concerted action and rewriting for this. Now the UvrD protein can use the cleavage to remove pairs of deoxyribose/phosphate groups and bases:

\begin{flalign*}
&\xrightarrow{\{ss[34],\underline{p5p3}[13]\}} \Rightarrow \xrightarrow{\{rr[35],\underline{at}[24]\}} \Rightarrow (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[35];r_2).T_2' \paral  (b_6[9];i_6).(g_1[25];r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
&(b_9[10];i_9).(c_1[23]).C_1' \paral (b_{10}[11];i_{10}).(c_2[27]).C_2' \paral (b_{11}[20];i_{11}).(c_3[25]).C_3'  \paral&&\\
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[34],p5_9[33];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10},p5_{10}[15];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n[31]).Me'\paral (m2[28],m2[29]).(l[30]).MS' \paral (l[30]).(n[31]).(o[32]).ML' \paral &&\\
&(o[32]).(w[33]).MH' \paral (u[35];r).(v[34];s).UD'&&
\end{flalign*}

From here, UvrD can ``walk'' along the strand. As opposed to BER, the bonds between the deoxyribose/phosphate groups and the bases are now broken:

\begin{flalign*}
&\xrightarrow{\{ss[36],\underline{p5p3}[15]\}} \Rightarrow \xrightarrow{\{rr[37],\underline{cg}[25]\}} \Rightarrow (p3_1,p5_1[1];s_1).(b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2).(b_2[8],d_2).DP_2' \paral (p3_3[2],p5_3[3];s_3).(b_3[6],d_3).DP_3' \paral &&\\
&(p3_4[3],p5_4[4];s_4).(b_4[9],d_4).DP_4' \paral (p3_5[4],p5_5[5];s_5).(b_5[7],d_5).DP_5' \paral (p3_6[5],p5_6;s_6).(b_6[11],d_6)).DP_6' \paral  &&\\
&(b_1[6];i_1).(a_1[24]).(m_1[27]).A_1' \paral (b_2[7];i_2).(a_2[28]).(m_2).A_2' \paral (b_3[18];i_3).(a_2[23]).(m_2).A_3' \paral &&\\
&(b_4[8];i_4).(t_1[23]:r_1).T_1' \paral (b_5[19];i_5).(t_2[35];r_2).T_2' \paral  (b_6[9];i_6).(g_1;r_3).G_1' \paral &&\\
&(b_7[17];i_7).(g_2[23];r_4).G_2' \paral (b_8[21];i_8).(g_2[29];r_4).G_3' \paral (b_9[22];i_9).(g_2[27];r_4).G_4' \paral&&\\
&(b_9[10];i_9).(c_1[23]).C_1' \paral (b_{10}[11];i_{10}).(c_2[27]).C_2' \paral (b_{11}[20];i_{11}).(c_3[37]).C_3'  \paral&&\\
&(p3_7,p5_7[12];s_7).(b_7[17],d_7).DP_7' \paral (p3_8[12],p5_8[13];s_8).(b_8[18],d_8).DP_8' \paral (p3_9[34],p5_9[33];s_9).(b_9[19],d_9).DP_9' \paral &&\\
&(p3_{10},p5_{10}[36];s_{10}).(b_{10}[20],d_{10})).DP_{10}' \paral  (p3_{11}[15],p5_{11}[16];s_{11}).(b_{11}[21],d_{11}).DP_{11}' \paral &&\\
&(p3_{12}[16],p5_{12};s_{12}).(b_{12}[22],d_{12}).DP_12' \paral  (m[27]).(n[31]).Me'\paral (m2[28],m2[29]).(l[30]).MS' \paral (l[30]).(n[31]).(o[32]).ML' \paral &&\\
&(o[32]).(w[33]).MH' \paral (u[37];r).(v[36];s).UD'&&
\end{flalign*}

This process can continue until the offending base has been removed. The protein complex can then unbond from the DNA and the exposed half-strand can be completed by the appropriate bases binding to them.
