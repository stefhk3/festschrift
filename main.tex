...
of oxygen to another oxygen. We show the transfer from $O_2$ to $O_1$, using the \emph{concerted actions} feature of CCB:
\begin{flalign*}
& ( (h_1[1];p).H'_1 \paral (h_2[2];p).H'_2 \paral (o_1[1],o_2[2],n[5]).O'_1 \paral 
(h_3[3];p[5]).H'_3 \\
&\paral (h_4[4];p).H'_4  \paral (o_3[3],o_4[4],n).O'_2) 
\setminus\{h_3,h_4,o_3,o_4,h_1,h_2,o_1,o_2,n,p\}\\
&\xrightarrow{\{ np[5], \underline{h_{3}o_{2}}[3]\}} \\
&( (h_1[1];p).H'_1 \paral (h_2[2];p).H'_2 \paral (o_1[1],o_2[2],n[5]).O'_1 \paral 
(h_3;p[5]).H'_3 \\
