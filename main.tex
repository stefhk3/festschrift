...
In this paper, we model DNA mismatch repair. Since this requires modelling complex molecules as opposed to atoms, we 
extend the prefix operator of CCB to have multiple bonding sites. We also extend operational semantics of concerted actions 
which allows us to cover a fuller range of covalent reactions involving concerted actions.  This builds upon our previous work on the modelling of BER and other biochemical reactions~\cite{10.1007/978-3-319-99498-7_8},  and shows that the mechanisms in CCB are relevant outside its original application area. 
