...
&(o).(w).\MutH' \paral (u;r) \paral (v;s).\UvrD'&&
\end{flalign*}
Note that leaving out some components results in an appearance of  several ``incomplete'' bonds, for example, between
...
\end{flalign*}
Note that by creating a bond between $\MutH$ and $\DP_9$ via actions $w$ and $s_9$ (key 33) leads to breaking a bond between two neighbouring deoxyribose/phosphate groups, namely $\DP_9$  and $\DP_8$ (key13).
%
