...
\psfrag{UD}{${\mathit{UvrD}}$}
  ...
  \caption[A six base pair DNA fragment.]{%A six base pair DNA fragment, with a DNA mismatch and methylation of one strand.
$\UvrD$ has now bonded to $G_3$ (the offending base) and $\DP_{12}$, breaking the bonds of those molecules to the rest of the DNA via concerted actions. The $C_3$-$\DP_{10}$ group, containing the offending base $C_3$,  is now removed (shown in grey).}
  \label{fig:state6}
\end{figure}
