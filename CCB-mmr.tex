...
%
The situation after this step is shown in Figure~\ref{fig:state2}, where the new bond (key 33) is shown as a bold line 
and the broken bond (key 13) is indicated by a dotted line.  This has now the right DNA strand cleaved.
...
bold lines show the bonds being created and the dotted lines indicate the bonds being broken.
