...
\begin{figure}[h!]
  \centering
    \includegraphics[width=1.0\textwidth]{mmr/Types_of_DNA_Damage.jpg}
...
\begin{flalign*}
&\xrightarrow{m2a[28]} \xrightarrow{m2g[29]} (p3_1,p5_1[1];s_1) \paral (b_1[10],d_1).DP_1' \paral (p3_2[1],p5_2[2];s_2) \paral &&\\
