...
\end{array}$$
%
We leave out the restriction from now on for ease of reading. We mark copies of processes $\DP$ and the bases, and their actions, using subscripts in order to make them unique. Pairs of keys show on which actions the initial bonds have been created. The MMR  system in full detail is given below, where henceforth we leave out the outermost restriction.
%
\begin{flalign*}
&((p3_1,p5_1[1];s_1) \wr (b_1[10],d_1)).DP_1' \paral ((p3_2[1],p5_2[2];s_2) \wr (b_2[8],d_2)).DP_2' \paral &&\\
&((p3_3[2],p5_3[3];s_3) \wr (b_3[6],d_3)).DP_3' \paral ((p3_4[3],p5_4[4];s_4) \wr (b_4[9],d_4)).DP_4' \paral &&\\
&((p3_5[4],p5_5[5];s_5) \wr (b_5[7],d_5)).DP_5' \paral ((p3_6[5],p5_6;s_6) \wr (b_6[11],d_6)).DP_6' \paral  &&\\
...
&((p3_7,p5_7[12];s_7) \wr (b_7[17],d_7)).DP_7' \paral ((p3_8[12],p5_8[13];s_8) \wr (b_8[18],d_8)).DP_8' \paral &&\\
&((p3_9[13],p5_9[14];s_9) \wr (b_9[19],d_9)).DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).DP_{12}' \paral  &&\\
&(m[40]).(n).Me'\paral (k,k).(l).MutS' \paral (l).(n).(o).MutL' \paral &&\\
&(o).(w).MutH' \paral ((u;r) \wr (v;s)).UvrD'&&
\end{flalign*}
...
&  ((p3_8[12],p5_8[13];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9[13],p5_9[14];s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(n).\Me'\paral (k,k).(l).\MutS' \paral (l).(n).(o).\MutL' \paral &&\\
&(o).(w).\MutH' \paral ((u;r) \wr (v;s)).\UvrD'&&
...
& (b_8[21];i_8).(\Blue{\bm{g_3}};r_8).G_3' \paral  ((p3_8[12],p5_8[13];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9[13],p5_9[14];s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
...
&(b_8[21];i_8).(\bm{g_3[29]};r_8).G_3' \paral ((p3_8[12],p5_8[13];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9[13],p5_9[14];s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
...
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],p5_8[13];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9[13],p5_9[14];s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral &&\\
...
&(b_8[21];i_8).(g_2[29];r_8).G_3' \paral ((p3_8[12],p5_8[13];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9[13],p5_9[14];s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(\bm{n[31]}).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(\bm{n[31]}).(\Blue{\bm{o}}).\MutL' \paral 
&&\\
&(\Blue{\bm{o}}).(w).\MutH' \paral ((u;r) \wr (v;s)).\UvrD'&&
\end{flalign*}
%
...
&(b_2[7];i_2).(a_2[28],m_2;r_2).A_2' \paral (b_5[19];i_5).(t_2[24];r_5).T_2' \paral (b_{12}[20];i_{12}).(c_3[25];r_{12}).C_3'  \paral&&\\
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],\Red{\bm{p5_8[13]}};\Blue{\bm{s_8}}) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((\Red{\bm{p3_9[13]}},p5_9[14];s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral &&\\
& ((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral &&\\
&(m[40]).(n[31]).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(n[31]).(\bm{o[32]}).\MutL' \paral &&\\
&(\bm{o[32]}).(\Blue{\bm{w}}).\MutH' \wr ((u;r) \paral (v;s)).\UvrD'&&
\end{flalign*}
%
...
&(b_2[7];i_2).(a_2[28],m_2;r_2).A_2' \paral (b_5[19];i_5).(t_2[24];r_5).T_2' \paral (b_{12}[20];i_{12}).(c_3[25];r_{12}).C_3'  \paral&&\\
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],\bm{p5_8};\bm{s_8[33]}) \wr (b_8[18],d_8)).DP_8' \paral &&\\
&((\bm{p3_9},p5_9[14];s_9) \wr (b_9[19],d_9)).DP_9' \paral ((p3_{10}[14],p5_{10}[15];s_{10}) \wr (b_{10}[20],d_{10})).DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).DP_{12}' \paral  &&\\
&(m[40]).(n[31]).Me'\paral (k[28],k[29]).(l[30]).MutS' \paral (l[30]).(n[31]).(o[32]).MutL' \paral &&\\
&(o[32]).(\bm{w[33]}).MutH' \paral ((u;r) \wr (v;s)).UvrD'&&
\end{flalign*}
...
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],\bm{p5_8[33]};\bm{s_8}) \wr (b_8[18],d_8)).DP_8' \paral &&\\
&((p3_9,\Red{\bm{p5_9[14]}};s_9) \wr (b_9[19],d_9)).DP_9' \paral ((\Red{\bm{p3_{10}[14]}},p5_{10}[15];\Blue{\bm{s_{10}}}) \wr (b_{10}[20],d_{10})).DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).DP_{12}' \paral  &&\\
&(m[40]).(n[31]).Me'\paral (k[28],k[29]).(l[30]).MutS' \paral (l[30]).(n[31]).(o[32]).MutL' \paral &&\\
&(o[32]).({w[33]}).MutH' \paral ((u;r) \wr (\Blue{\bm{v}};s)).UvrD'&&
\end{flalign*}
...
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],p5_8[33];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9,\bm{p5_9};s_9) \wr (b_9[19],d_9))\paral.\DP_9' \paral ((\bm{p3_{10}[34]},p5_{10}[15];\bm{s_{10}}) \wr (b_{10}[20],d_{10})).\DP_{10}'   &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(n[31]).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(n[31]).(o[32]).\MutL' \paral &&\\
&(o[32]).(w[33]).\MutH' \paral ((\Blue{\bm{u}};r) \wr (\bm{v[34]};s)).\UvrD'&&
\end{flalign*}
...
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],p5_8[33];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9,p5_9;s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10}[34],p5_{10}[15];\bm{s_{10}}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral  &&\\
&((p3_{11}[15],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(n[31]).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(n[31]).(o[32]).\MutL' \paral &&\\
&(o[32]).(w[33]).\MutH' \paral ((\bm{u[35]};r) \wr (v[34];s)).\UvrD'&&
\end{flalign*}
...
&(b_8[21];i_8).(g_3[29];r_8).G_3' \paral ((p3_8[12],p5_8[33];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9,p5_9;s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((\Red{\bm{p3_{10}[34]}},\Red{\bm{p5_{10}[15]}};s_{10}) 
 \wr (b_{10}[20],d_{10})).\DP_{10}' \paral  &&\\
&((\Red{\bm{p3_{11}[15]}},p5_{11}[16];\Blue{\bm{s_{11}}}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(n[31]).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(n[31]).(o[32]).\MutL' \paral &&\\
&(o[32]).(w[33]).\MutH' \paral ((u[35];r) \wr (\Red{\bm{v[34]}};\Blue{\bm{s}})).\UvrD'&&\\
%
...
&(b_8[21];i_8).(g_2[29];r_4).G_3' \paral ((p3_8[12],p5_8[33];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9,p5_9;s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((\bm{p3_{10},p5_{10}};s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral &&\\
&((\bm{p3_{11}[36]},p5_{11}[16];\bm{s_{11}}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(n[31]).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(n[31]).(o[32]).\MutL' \paral &&\\
&(o[32]).(w[33]).\MutH' \paral ((\Red{\bm{u[35]}};\Blue{\bm{r}}) \wr (\bm{v[36]};\bm{s})).\UvrD'&&
\end{flalign*}
...
&(b_8[21];i_8).(g_2[29];r_4).G_3' \paral  ((p3_8[12],p5_8[33];s_8) \wr (b_8[18],d_8)).\DP_8' \paral &&\\
&((p3_9,p5_9;s_9) \wr (b_9[19],d_9)).\DP_9' \paral ((p3_{10},p5_{10};s_{10}) \wr (b_{10}[20],d_{10})).\DP_{10}' \paral &&\\
&((p3_{11}[36],p5_{11}[16];s_{11}) \wr (b_{11}[21],d_{11})).\DP_{11}' \paral ((p3_{12}[16],p5_{12};s_{12}) \wr (b_{12}[22],d_{12})).\DP_{12}' \paral  &&\\
&(m[40]).(n[31]).\Me'\paral (k[28],k[29]).(l[30]).\MutS' \paral (l[30]).(n[31]).(o[32]).\MutL' \paral &&\\
&(o[32]).(w[33]).\MutH' \paral ((\bm{u[37]};\bm{r}) \wr (v[36];s)).\UvrD'&&
\end{flalign*}
...
a fixed size and it can only react with parts of the DNA it can physically reach. 
\item Similarly, $\UvrD$ can bond to any deoxyribose/phosphate group, not just the neighbouring one. Moreover, 
when $\UvrD$ bonds on weak $s$, there is no way to differentiate between $p3$ or $p5$ of $\DP$ being broken in our model.
% when the weak action s happens, and this is a shortcoming. 
